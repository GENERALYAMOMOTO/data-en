...
functions.get_file_size(dataset, file_name, "data/asteroid_data/file_size_unopt_res.json")
...
functions.get_file_size(dataset, file_name, "data/asteroid_data/file_size_opt_res.json")
...
for chunk in pd.read_csv(file_name,
    ...
    chunk.to_csv("data/asteroid_data/df.csv", mode="a", header=has_header)
    break
...
functions.write_to_json('data/asteroid_data/dtypes.json', dtype_json)