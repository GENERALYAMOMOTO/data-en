...
functions.get_file_size(dataset, file_name, "data/auto_data/file_size_unopt_res.json")
...
functions.get_file_size(dataset, file_name, "data/auto_data/file_size_opt_res.json")
...
need_column = {}
column_names = ['vin', 'msrp','askPrice',
                'mileage','isNew','color','interiorColor',
                'brandName','modelName','dealerID']
...
for chunk in pd.read_csv(file_name,
    ...
    chunk.to_csv("data/auto_data/df.csv", mode="a", header=has_header)
    break
...
functions.write_to_json('data/auto_data/dtypes.json', dtype_json)